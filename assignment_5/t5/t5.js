var map = L.map('map').setView([60.188222, 24.829696], 8);
...
restaurants.forEach(function (restaurant) {
  ...
  marker.bindPopup(
    `<b>${restaurant.name}</b><br>${restaurant.address}, ${restaurant.city}`
  );
});
...
restaurants.forEach(function (restaurant) {
  ...
  marker.on('click', function (e) {
    document.getElementById('modalName').innerHTML = restaurant.name;
    document.getElementById('modalAddress').innerHTML = restaurant.address;
